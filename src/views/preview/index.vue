  ...
  <div class="preview-container">
    <section class="main" v-scroll-view="checkSubCategory">
      ...
      <div class="category-title-wrapper">
        <div class="category" v-for="category in categoryList" :key="category.id" @click="handleChangeCategory(category)">
          {{ category.name }}
        </div>
      </div>
      ...
      <div class="nav-wrapper">
        ...
        >
          ...
          <ul class="nav-list">
            <li class="nav-item" v-for="site in subCategory.navigation" :key="site.id">
              <a class='nav-link' target='_blank' :href="site.url">
                ...
                <div class='nav' :title='site.description ? site.description : "暂无备注"'>
                  {{ site.name }}
                </div>
              </a>
            </li>
...
const defaultIcon = 'https://cdn.jsdelivr.net/gh/carolin-violet/navigation_v1/images/browser.svg'
